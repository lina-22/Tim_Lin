...
var_dump($_GET);
require ("data.php");
function rechercheStagiaire($arrayStagiaire,$unId)
{
    foreach($arrayStagiaire as $unStagiaire){
        ...
        if($unId==$unStagiaire["idStagiaire"])
        {
            return $unStagiaire;
        }
    }
...
$leStagiaire=$stagiaire=rechercheStagiaire($stagiaires,$_GET["id"]);
var_dump($stagiaire);
...
<body>
    ...
    <main class="container-fluid vh-100">
        <section>
            <h1><?=$leStagiaire["nom"]?></h1>
            <h1><?=$leStagiaire["prenom"]?></h1>
            <a href="mailto:<?=$leStagiaire["email"]?>"><?= $leStagiaire["email"]?></a>
        </section>
    </main>
    <?php
