...
class CountryManager{
    ...
    /**
     * @param $aName String le nom du pays
     * @param $aRegion String la region
     * @param $aPopulation int la population
     * @param $aSubregion String la sous region
     * @param $aCapital String la capitale
