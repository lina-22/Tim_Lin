...
$leStagiaire=rechercheUnStagiaire($stagiaires, $_GET["id"]);
        ...
        <form action="traitementAjoutStagiaire.php" method="post">
            ...
            <div class="col-lg-4 col-md-6 col-10 mx-auto my-3 row">
                ...
                <div class="col col-sm-9">
                    <input class="form-control" value="<?=$leStagiaire["nom"]?>" type="text" name="nom" id="inputNom" required>
                    
                    <!-- here i add value upside -->
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-10 mx-auto my-3 row">
                ...
                <div class="col col-sm-9">
                    <input class="form-control" value="<?=$leStagiaire["prenom"]?>" type="text" name="prenom" id="inputPrenom" required>
            ...
            <div class="col-lg-4 col-md-6 col-10 mx-auto my-3 row">
                ...
                <div class="col col-sm-9">
                    <input class="form-control" value="<?=$leStagiaire["email"]?>" type="email" name="email" id="inputEmail" required>
