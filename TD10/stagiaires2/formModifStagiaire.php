        ...
        <form action="traitementAjoutStagiaire.php" method="post">
            ...
            <div class="col-lg-4 col-md-6 col-10 mx-auto my-3 row">
                ...
                <div class="col col-sm-9">
                    <input class="form-control" value="<?=$_GET["nom"]?>" type="text" name="nom" id="inputNom" required>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-10 mx-auto my-3 row">
                ...
                <div class="col col-sm-9">
                    <input class="form-control" value="<?=$_GET["prenom"]?>" type="text" name="prenom" id="inputPrenom" required>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-10 mx-auto my-3 row">
                ...
                <div class="col col-sm-9">
                    <input class="form-control" value="<?=$_GET["email"]?>" type="email" name="email" id="inputEmail" required>
